package com.example.examen2angel.ui
...
import com.example.examen2angel.R
import com.example.examen2angel.ui.ViewModel.AppViewModel
        ...
        NavHost(
            ...
            composable(route = Pantallas.Pantalla1.name) {
                PrimeraPantalla(
                    ...
                    onBotonAtrasPulsado = {navController.popBackStack(Pantallas.Inicio.name, inclusive = false)},
                    modifier = Modifier
                        .fillMaxSize()
                )
            }
